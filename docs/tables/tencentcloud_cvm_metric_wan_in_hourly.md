...
Each row represents a single hourly data point of one instance: the instance ID, the timestamp of the data point, and the public network inbound bandwidth value (in Mbps). The public bandwidth values are the combined outbound/inbound traffic of the instance together with its associated EIP and CLB.
...
### Basic hourly public network inbound bandwidth
