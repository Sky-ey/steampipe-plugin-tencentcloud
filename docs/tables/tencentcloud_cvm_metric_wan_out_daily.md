...
Each row represents a single daily data point of one instance: the instance ID, the timestamp of the data point, and the public network outbound bandwidth value (in Mbps). The values are the outbound traffic of the instance together with its associated EIP and CLB.
